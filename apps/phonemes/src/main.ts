...
function renderPairButtons(): void {
  ...
  btnVoiced.innerHTML   = `<span class="ipa">/${pair.voiced.ipa}/</span><span class="letter">${pair.voiced.letter}</span>`;
  btnUnvoiced.innerHTML = `<span class="ipa">/${pair.unvoiced.ipa}/</span><span class="letter">${pair.unvoiced.letter}</span>`;
